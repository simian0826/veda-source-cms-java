package tech.vedaSource.cms.infra.storage;
...
import tech.vedaSource.cms.common.NanoId;
import tech.vedaSource.cms.sys.event.StorageConfigCreated;
import tech.vedaSource.cms.sys.event.StorageConfigDeleted;
import tech.vedaSource.cms.sys.model.StorageConfig;
import tech.vedaSource.cms.sys.model.StorageFile;
import tech.vedaSource.cms.sys.repository.StorageConfigRepository;
import tech.vedaSource.cms.sys.repository.StorageFileRepository;
import tech.vedaSource.cms.sys.service.StorageService;
import tech.vedaSource.cms.sys.service.dto.StorageFileDTO;
import tech.vedaSource.cms.sys.event.StorageConfigMarkedAsDefault;
import tech.vedaSource.cms.sys.event.StorageConfigUpdated;
import tech.vedaSource.cms.sys.exception.StorageException;
...
public class StorageServiceImpl implements StorageService {
  ...
  public StorageConfig getConfig(Long id) {
    return storageConfigRepository.findById(id)
      .orElseThrow(() -> new StorageException(CommonResultStatus.FAIL, "存储配置不存在"));
  }
  ...
  public void deleteConfig(StorageConfig storageConfig) {
    if (storageConfig.isDefault()) {
      throw new StorageException(CommonResultStatus.FAIL, "不能删除默认配置");
    }
  ...
  @Override
  @Transactional
  public StorageFileDTO store(String storageId, InputStream inputStream, long contentLength, String contentType, String filename, String domain) {
